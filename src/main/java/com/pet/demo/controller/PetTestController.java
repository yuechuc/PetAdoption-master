...
public class PetTestController {
    ...
    public String savePet(@RequestParam(value = "petPic") MultipartFile file,HttpServletRequest request){
        ...
        String filePath = "/Users/yuechu/Pictures/pet_images/upload/"; // 上传后的路径
...
//         图片上传到服务器
//        try {
//            String fileName2 = uCloudProvider.upload(file.getInputStream(), file.getContentType(), file.getOriginalFilename());
//
//           File file1 = new File(filePath + fileName2);
//            fileDTO dto = new fileDTO();
//            dto.setSuccess(String.valueOf(1));
//            dto.setUrl(fileName2);
//
//            //String fileName = uCloudProvider.upload(file.getInputStream(), file.getContentType(), file.getOriginalFilename());
//            //fileDTO = new File(filePath + fileName);
